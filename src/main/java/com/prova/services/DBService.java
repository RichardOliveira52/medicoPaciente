...
public class DBService {
    ...
    public void initDB(){
        Medico medico01 = new Medico(0,"Richard",LocalDate.now(),new BigDecimal("5000.00"));
        Paciente paciente01 = new Paciente(0,"Marcela",LocalDate.now(),new BigDecimal("2000.00"));
